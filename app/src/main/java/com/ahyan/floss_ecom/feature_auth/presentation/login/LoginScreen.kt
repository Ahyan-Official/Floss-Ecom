package com.ahyan.floss_ecom.feature_auth.presentation.login
...
import com.ahyan.floss_ecom.core.domain.model.TextFieldState
...
import com.ahyan.floss_ecom.core.presentation.ui.theme.roboto

import com.ahyan.floss_ecom.core.util.UiEvents
import com.ahyan.floss_ecom.destinations.ForgotPasswordScreenDestination
import com.ahyan.floss_ecom.destinations.RegisterScreenDestination
        ...
        item {
            ...
            Row(
                ...
                Row(
                    ...
                    Text(text = "Remember me", fontSize = 12.sp,color = TextColor)
                }
        ...
        item {
            ...
            Button(
                ...
                Text(
                    modifier = Modifier
                        .fillMaxWidth()
                        .padding(12.dp), text = "Sign In", textAlign = TextAlign.Center, color = Color.DarkGray
                )
            }
        }
